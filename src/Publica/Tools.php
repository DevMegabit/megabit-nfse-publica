...
namespace NFePHP\NFSePublica\Publica;
...
use NFePHP\NFSePublica\Common\Publica\Tools as BaseTools;
...
class Tools extends BaseTools
{
     ...
     */
    public function __construct($config, Certificate $cert, $versionSchema = "2.02")
    {
        parent::__construct($config, $cert);
        $path = realpath(
            __DIR__ . '../../../storage/schemes'
        );
        $this->schema =  "schema_nfse_v$versionSchema.xsd";
